...
let appTarget: Target = .target(
    ...
    sources: ["{{ cookiecutter.__app_name }}/Sources/**"],
    resources: ["{{ cookiecutter.__app_name }}/Resources/**"],
...
let appTestTarget: Target = .target(
    name: "{{ cookiecutter.__app_name }}Tests",
    destinations: .appDestinations,
    product: .unitTests,
    bundleId: bundleID(name: "{{ cookiecutter.__app_name }}Tests"),
    deploymentTargets: .appDeploymentTargets,
    infoPlist: .default,
    sources: ["{{ cookiecutter.__app_name }}/Tests/**"],
    resources: [],
    dependencies: [.target(name: "{{ cookiecutter.__app_name }}")] + appTarget.dependencies
)
